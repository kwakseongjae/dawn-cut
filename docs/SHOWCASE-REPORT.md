...
- **색보정 강도:** (작성시점 진단) 5프리셋이 절제됐고 cinematic 코드가 1.2로 약했음. **→ 정정 완료:** cinematic 1.30/0.70로 정렬 + **`vivid`(채도 1.60) 1탭 프리셋 추가**(상단 배너 참조). 남은 것은 콘텐츠 **적응형 강도(signalstats)** — 저조도 소스 임팩트용, 후속.
